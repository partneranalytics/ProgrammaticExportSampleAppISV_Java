package com.microsoft.partneranalytics.sampleprogrammaticaccess.controllers;
...
import com.microsoft.partneranalytics.sampleprogrammaticaccess.helpers.*;
...
@RestController
@RequestMapping("ProgrammaticExportSampleAppISV")
public class ProgrammaticExportSampleAppController {
    ...
    Logger _logger = LoggerFactory.getLogger(ProgrammaticExportSampleAppController.class);
    ...
    public ResponseEntity GetDatasets(){
        ...
        String datasetPath = env.getProperty("ProgrammaticExport.DatasetsPath");
    ...
    public ResponseEntity GetQueries(){
        ...
        String baseUrl = env.getProperty("ProgrammaticExport.ApiEndpointUrl");
        String queryPath = env.getProperty("ProgrammaticExport.QueryPath");
    ...
    public ResponseEntity TryQuery(@RequestParam String export_query){
        ...
        String baseUrl = env.getProperty("ProgrammaticExport.ApiEndpointUrl");
        String datasetPath = env.getProperty("ProgrammaticExport.QueryPath") + "/testQueryResult?exportQuery=" + export_query;
    ...
    public ResponseEntity CreateReport(@RequestParam String query_id, @RequestParam String report_name, @RequestParam String report_start_name, @RequestParam int recurrence_interval, @RequestParam String recurrence_count){
        ...
        ScheduledReportCreateInputObject payload = new ScheduledReportCreateInputObject(report_name, query_id, report_start_name, recurrence_interval, Integer.parseInt(recurrence_count));

        String baseUrl = env.getProperty("ProgrammaticExport.ApiEndpointUrl");
        String queryPath = env.getProperty("ProgrammaticExport.ReportPath");
